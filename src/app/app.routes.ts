...
import { MyProfileIconComponent } from './backoffice/activate-icons-menu/my-profile-icon/my-profile-icon.component';
import { MyPasswordIconComponent } from './backoffice/activate-icons-menu/my-password-icon/my-password-icon.component';
import { MyProductsIconComponent } from './backoffice/activate-icons-menu/my-products-icon/my-products-icon.component';
...
export const routes: Routes = [
  ...
  // www.ejemplo.com/app  
  {
    path: "app", component: LayoutBackComponent, children: [ // -> www.ejemplo.com/app
      ...
      {path: "profile", component: MyProfileIconComponent},
      {path: "password", component: MyPasswordIconComponent},
      {path: "products", component: MyProductsIconComponent},
    ]
  },
